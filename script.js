document.addEventListener('DOMContentLoaded', () => {
 ...
    const API_BASE_URL = localStorage.getItem('apiUrl') || 'https://duende-api.vercel.app';
 ...
            if (result && result.content) {
                // Se usa la librería marked, que debe estar importada en el HTML
                let text = marked.parse(result.content);
